...
- ⏳ **Cutover do login (Fase 1-2) BLOQUEADO** nesta sessão: provisionar os 42 exige a `service_role` e a Management API `/api-keys` estava com rate-limit. Runbook pronto (ver docs/remediacao-seguranca).
